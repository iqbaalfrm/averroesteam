...
class BaseConfig:
    ...
    ZAKAT_GOLD_GRAMS_NISHAB = float(os.getenv("ZAKAT_GOLD_GRAMS_NISHAB", "85"))
    GOLD_PRICE_API_URL = os.getenv("GOLD_PRICE_API_URL", "https://api.gold-api.com/price/XAU")
    USD_IDR_RATE_API_URL = os.getenv("USD_IDR_RATE_API_URL", "https://open.er-api.com/v6/latest/USD")
    ZAKAT_PRICE_CACHE_SECONDS = int(os.getenv("ZAKAT_PRICE_CACHE_SECONDS", "3600"))
    ZAKAT_BAZNAS_URL = os.getenv("ZAKAT_BAZNAS_URL", "https://bayarzakat.baznas.go.id/zakat")
